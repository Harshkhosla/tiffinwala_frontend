        ...
        <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 mt-7">
            <div className="flex justify-center items-center lg:flex-row flex-col gap-8">
                ...
                <div className="  w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center">
                    ...
                    <div className="lg:mt-11 mt-10">
                        ...
                        <div className="flex flex-row justify-between items-center mt-4">
                            ...
                            <svg
                                ...
                                id="rotateSVG"
                                className={`focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 cursor-pointer transform ${rotate ? "rotate-180" : "rotate-0"}`}
                                width="10"
                                height="6"
                                viewBox="0 0 10 6"
                                fill="none"
                        ...
                        {showDetails && (
                            <div className="mt-2 text-gray-600">
                                <p><strong>Weight:</strong> {Tiffindata?.dimensions?.weight}</p>
                                <p><strong>Servings:</strong> {Tiffindata?.dimensions?.servings}</p>
                            </div>
                        )}
                        <hr className="bg-gray-200 w-full mt-4" />
                        <div className="flex flex-row justify-between items-center mt-4">
                            <p className="font-medium text-base leading-4 text-gray-600">Benefits</p>
                            <svg
                                onClick={toggleDetails1}
                                id="rotateSVG"
                                className={`focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 cursor-pointer transform ${rotate1 ? "rotate-180" : "rotate-0"}`}
                                width="10"
                                height="6"
                                viewBox="0 0 10 6"
                                fill="none"
                        ...
                        {showDetails1 && (
                            <div className="mt-2 text-gray-600">
                                {Tiffindata?.benefits?.map((benefit, index) => (
                                    <li key={index} className="leading-2">
                                        {benefit}
                                    </li>
                                ))}
                    ...
                    <button className="focus:outline-none focus:ring-2 hover:bg-black focus:ring-offset-2 focus:ring-gray-800 font-medium text-base leading-4 text-white bg-gray-800 w-full py-5 lg:mt-12 mt-6">{Tiffindata?.buttonText}</button>
                </div>
            ...
            <div className="flex  justify-center items-center w-full">
                ...
                {Tiffindata.feature?.map((data, index) => (
    <div key={index} className="feature-item mt-6">
        ...
        <p className="text-normal text-base leading-6 text-gray-600 mt-4">{data.description}</p>
    </div>
))}
